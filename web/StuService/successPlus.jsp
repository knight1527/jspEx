  ...
  <div class="ui container">
    <div class="ui menu m-padded">
      ...
      <div class="right menu">
        <a href="../UserService/logout.jsp" class="ui item button m-color">退出</a>
      </div>
    </div>
    <div class="ui segment">
      ...
      <div class="ui container" style="height: auto;border: none;">
        <div id="table-container" style="border: none;">
          <table class="ui celled table">
            ...
            <tbody>
            <%
              int beg = Integer.parseInt(request.getParameter("beg"));
            ...
            <tr>
              <th colspan="4" class="center aligned">
                <div>
                  <%
                    List<String[]> total = getAllStudent(0,"");
                    int i = (int)Math.ceil(total.size()/5.0);
                    for(int j=0;j<i;j++){
                  %>
                  <a class="ui mini button" href="successPlus.jsp?beg=<%=j*5%>"><%=j+1%></a>
                  <%
                    }
                  %>
                </div>
              ...
              <th class="center aligned">
                  <p class="m-color">共&nbsp;<span><%=total.size()%></span>&nbsp;条数据</p>
              </th>
              <th class="center aligned">
